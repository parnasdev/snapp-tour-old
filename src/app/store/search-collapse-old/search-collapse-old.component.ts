...
@Component({
  selector: 'prs-search-collapse-old',
  templateUrl: './search-collapse-old.component.html',
  styleUrls: ['./search-collapse-old.component.scss']
})
export class SearchCollapseOldComponent implements OnInit {
